...
TabInfo:CreateLabel("Version 1.0.0 (Anime Dice)")
TabInfo:CreateLabel("Cooming Soon Next Update: Next Update of Dice Anime Script On Sunday, September 13, 2026")

TabInfo:CreateSection("Daftar Fitur Lengkap", "Penjelasan Fungsi")
TabInfo:CreateLabel("1. Auto Roll & Equip Best | 2. Auto Collect Cash (Loop Slot) | 3. Auto Upgrade Plot (Loop Slot)")

-- ==========================================
-- TAB AUTO ROLL & FARM
-- ==========================================
local TabFarm = Window:CreateTab("zap") -- fast/zap icon
TabFarm:CreateSection("Auto Roll Dice", "Spam remote RollDice secara cepat")

local autoFastRoll = false
local tglRoll = TabFarm:CreateToggle("Auto Fast Roll", function(state) autoFastRoll = state end)
TabFarm:CreateKeybind("Toggle Fast Roll", "F", function() tglRoll:Toggle() end)
...
TabFarm:CreateSection("Auto Equip Best", "Spam equip dadu/unit terbaik")
