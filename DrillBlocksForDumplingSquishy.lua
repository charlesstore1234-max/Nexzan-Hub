...
pcall(function() mapName = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name end)
    ...
    CreateTag("1.0.0", Icons["info"] or "rbxassetid://124560466474914")
...
TabInfo:CreateLabel("Next Update Script Cooming Soon : Next Script Update on Sunday, September 13, 2026, 7:00 PM - 9:00 PM WIB")
...
TabFarm:CreateSection("Auto Upgrade Squishy", "Level up otomatis Squishy di Plot")

local autoUpgradeSquishy = false
local upgradeSpeed = 10
local maxUpgradeSlot = 10

TabFarm:CreateInput("Masukkan Max Slot", "Contoh: 10", function(val) 
...
TabFarm:CreateSlider("Spam Speed (Upgrade)", 1, 50, 10, function(val) upgradeSpeed = val end)

local tglUpgrade = TabFarm:CreateToggle("Auto Upgrade Squishy", function(state) autoUpgradeSquishy = state end)
TabFarm:CreateKeybind("Toggle Upgrade Squishy", "V", function() tglUpgrade:Toggle() end)
